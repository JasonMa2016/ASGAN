...
G = Generator()
G_old = copy.deepcopy(G) # TODO: will this work with cuda?
D = Discriminator()
...
for epoch in range(train_epoch):
    ...
    p = SAVEDIR+'/Random_results/MNIST_DCGAN_' + str(epoch + 1) + '.png'
    fixed_p = SAVEDIR+'/Fixed_results/MNIST_DCGAN_' + str(epoch + 1) + '.png'
