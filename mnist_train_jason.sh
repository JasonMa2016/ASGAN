...
aws s3 cp ../data/ASGAN_MNIST_1/Fixed_results/25.png s3://am2211/ASGAN_MNIST_1/point1.png
python mnist_gan.py -m 1 -sd ../data/ASGAN_MNIST_1 -t 0.2
echo "alpha=0.2" >> ../data/ASGAN_MNIST_1/results.txt
python mnist_evaluate.py -sd ../data/ASGAN_MNIST_1 >> ../data/ASGAN_MNIST_1/results.txt
aws s3 cp ../data/ASGAN_MNIST_1/Fixed_results/25.png s3://am2211/ASGAN_MNIST_1/point2.png
python mnist_gan.py -m 1 -sd ../data/ASGAN_MNIST_1 -t 0.3
echo "alpha=0.3" >> ../data/ASGAN_MNIST_1/results.txt
python mnist_evaluate.py -sd ../data/ASGAN_MNIST_1 >> ../data/ASGAN_MNIST_1/results.txt
aws s3 cp ../data/ASGAN_MNIST_1/Fixed_results/25.png s3://am2211/ASGAN_MNIST_1/point2.png
python mnist_gan.py -m 1 -sd ../data/ASGAN_MNIST_1 -t 0.4
echo "alpha=0.4" >> ../data/ASGAN_MNIST_1/results.txt
python mnist_evaluate.py -sd ../data/ASGAN_MNIST_1 >> ../data/ASGAN_MNIST_1/results.txt
aws s3 cp ../data/ASGAN_MNIST_1/Fixed_results/25.png s3://am2211/ASGAN_MNIST_1/point4.png
python mnist_gan.py -m 1 -sd ../data/ASGAN_MNIST_1 -t 0.5
echo "alpha=0.4" >> ../data/ASGAN_MNIST_1/results.txt
python mnist_evaluate.py -sd ../data/ASGAN_MNIST_1 >> ../data/ASGAN_MNIST_1/results.txt
aws s3 cp ../data/ASGAN_MNIST_1/Fixed_results/25.png s3://am2211/ASGAN_MNIST_1/point4.png
...
python mnist_evaluate.py -sd ../data/ASGAN_MNIST_1 >> ../data/ASGAN_MNIST_1/results.txt
aws s3 cp ../data/ASGAN_MNIST_1/Fixed_results/25.png s3://am2211/ASGAN_MNIST_1/point6.png
# python mnist_gan.py -m 1 -sd ../data/ASGAN_MNIST_1 -t 0.8
# echo "alpha=0.8" >> ../data/ASGAN_MNIST_1/results.txt
# python mnist_evaluate.py -sd ../data/ASGAN_MNIST_1 >> ../data/ASGAN_MNIST_1/results.txt
# aws s3 cp ../data/ASGAN_MNIST_1/Fixed_results/25.png s3://am2211/ASGAN_MNIST_1/point8.png
...
aws s3 cp ../data/*/results.txt s3://am2211