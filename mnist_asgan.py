...
# test
# print('hi g', G(torch.randn((43, 100)).view(-1, 100, 1, 1)).shape)
# print('hi', D(stack(next(iter(train_loader))[0])).shape)
...
# results save folder
if not os.path.isdir('MNIST_ASGAN_results'):
    os.mkdir('MNIST_ASGAN_results')
if not os.path.isdir('MNIST_ASGAN_results/Random_results'):
    os.mkdir('MNIST_ASGAN_results/Random_results')
if not os.path.isdir('MNIST_ASGAN_results/Fixed_results'):
    os.mkdir('MNIST_ASGAN_results/Fixed_results')
...
for epoch in range(train_epoch):
    ...
    p = 'MNIST_ASGAN_results/Random_results/MNIST_ASGAN_' + str(epoch + 1) + '.png'
    fixed_p = 'MNIST_ASGAN_results/Fixed_results/MNIST_ASGAN_' + str(epoch + 1) + '.png'
...
torch.save(G.state_dict(), "MNIST_ASGAN_results/generator_param.pkl")
torch.save(D.state_dict(), "MNIST_ASGAN_results/discriminator_param.pkl")
with open('MNIST_ASGAN_results/train_hist.pkl', 'wb') as f:
    pickle.dump(train_hist, f)

show_train_hist(train_hist, save=True, path='MNIST_ASGAN_results/MNIST_ASGAN_train_hist.png')
